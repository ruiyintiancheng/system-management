      ...
      <div v-show="searchToggle"
        ...
        <el-form ref="formHeard"
          ...
          <div class="input-both-4">
            <el-form-item>
              <span class="input-label">字段名</span>
              <el-input class="form-input"
                        v-model="searchData.columnName"
                        clearable></el-input>
            </el-form-item>
          </div>
          <div class="input-both-4">
...
const url = '/basic/users/getUserAllColumnPermission'
export default {
  name: 'userManagementComponentsPermissionViewColumnView',
  components: {
    BasicTable
  },
  props: {
