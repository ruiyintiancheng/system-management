...
export default {
  ...
  methods: {
    searchOption() {
      ...
      param.userId = (this.paramData.userId || this.paramData.userId === 0) ? this.paramData.userId : null
      param.roleId = (this.paramData.roleId || this.paramData.roleId === 0) ? this.paramData.roleId : null
